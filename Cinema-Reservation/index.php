...
<body>
    ...
    <div id="home-section-2" class="services-section">
        <h1>Bagaimana Caranya Menonton?</h1>
        <h3>3 Langkah sederhana untuk memesan film favorit Anda!</h3>
        ...
        <div class="services-container">
            <div class="service-item">
                ...
                <h2>1. Pilih Film Favorit Anda</h2>
                <p>pilih film yang ingin Anda tonton di bioskop kami</p>
            </div>
            <div class="service-item">
                <div class="service-item-icon">
                    <i class="fas fa-4x fa-credit-card"></i>
                </div>
                <h2>2. Bayar tiket Anda</h2>
                <p>pilih film yang ingin Anda tonton di bioskop kami</p>
            </div>
            <div class="service-item">
                <div class="service-item-icon">
                ...
                <h2>3. Pilih tempat duduk Anda & Nikmati menonton</h2>
                <p>pilih film yang ingin Anda tonton di bioskop kami</p>
            </div>
    ...
    <div id="home-section-3" class="trailers-section">
        <h1 class="section-title">Jelajahi Film Baru</h1>
        <h3>Sekarang Ditampilkan</h3>
